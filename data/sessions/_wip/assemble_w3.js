...
const DIMS = {
  ...
  // ── Week 5：原子鍵結與晶體結構（Callister Ch.2–3）｜stage 2 ──
  S65: { week:5, order:65, title:'Ch.2 重讀（一）', titleEn:'Callister Ch.2 Review I', platform:'callister', gradImportance:'important', tier:'core', cognition:'concept', prereq:['S36','S39'], assessWeight:'medium', extension:'life', gradCourse:['general'] },
  S66: { week:5, order:66, title:'Ch.2 重讀（二）：能量-距離曲線', titleEn:'Ch.2 Review II — Energy-Distance Curve', platform:'callister', gradImportance:'essential', tier:'core', cognition:'concept', prereq:['S65','S40'], assessWeight:'medium', extension:'life', gradCourse:['general'] },
  S67: { week:5, order:67, title:'Ch.2 課後題', titleEn:'Ch.2 Problems', platform:'callister', gradImportance:'support', tier:'tool', cognition:'synthesis', prereq:['S66'], assessWeight:'light', extension:'none', gradCourse:['general'] },
  S68: { week:5, order:68, title:'Ch.3 晶體結構（一）', titleEn:'Ch.3 Crystal Structures I', platform:'callister', gradImportance:'essential', tier:'core', cognition:'concept', prereq:['S59'], assessWeight:'medium', extension:'none', gradCourse:['general'] },
  S69: { week:5, order:69, title:'Ch.3 晶體結構（二）：APF', titleEn:'Ch.3 Crystal Structures II — APF', platform:'callister', gradImportance:'essential', tier:'core', cognition:'calculation', prereq:['S68','S60'], assessWeight:'medium', extension:'none', gradCourse:['general'] },
  S70: { week:5, order:70, title:'密度計算', titleEn:'Theoretical Density Calculation', platform:'callister', gradImportance:'essential', tier:'core', cognition:'calculation', prereq:['S69','S60'], assessWeight:'medium', extension:'none', gradCourse:['general'] },
  S71: { week:5, order:71, title:'晶面晶向（一）', titleEn:'Planes & Directions I (Miller Indices)', platform:'doitpoms', gradImportance:'important', tier:'core', cognition:'concept', prereq:['S61'], assessWeight:'medium', extension:'none', gradCourse:['general'] },
  S72: { week:5, order:72, title:'晶面晶向（二）：晶面間距', titleEn:'Planes & Directions II — d-spacing', platform:'callister', gradImportance:'important', tier:'core', cognition:'calculation', prereq:['S71'], assessWeight:'medium', extension:'research', gradCourse:['general'] },
  S73: { week:5, order:73, title:'多晶與單晶', titleEn:'Polycrystalline vs Single Crystal', platform:'doitpoms', gradImportance:'important', tier:'core', cognition:'concept', prereq:['S68'], assessWeight:'medium', extension:'packaging', gradCourse:['general'] },
  S74: { week:5, order:74, title:'各向異性', titleEn:'Anisotropy', platform:'callister', gradImportance:'important', tier:'core', cognition:'concept', prereq:['S73'], assessWeight:'medium', extension:'life', gradCourse:['general'] },
  S75: { week:5, order:75, title:'X光繞射原理（一）', titleEn:'X-ray Diffraction I — Bragg Law', platform:'doitpoms', gradImportance:'essential', tier:'core', cognition:'concept', prereq:['S72'], assessWeight:'heavy', extension:'research', gradCourse:['general'] },
  S76: { week:5, order:76, title:'X光繞射原理（二）：讀圖', titleEn:'X-ray Diffraction II — Reading Patterns', platform:'callister', gradImportance:'important', tier:'core', cognition:'chartread', prereq:['S75'], assessWeight:'medium', extension:'research', gradCourse:['general'] },
  S77: { week:5, order:77, title:'Week 5 整合（一）', titleEn:'Week 5 Integration I', platform:'self', gradImportance:'support', tier:'tool', cognition:'synthesis', prereq:['S65','S68','S75'], assessWeight:'light', extension:'none', gradCourse:['general'] },
  S78: { week:5, order:78, title:'Week 5 整合（二）', titleEn:'Week 5 Integration II', platform:'callister', gradImportance:'support', tier:'tool', cognition:'synthesis', prereq:['S68'], assessWeight:'light', extension:'none', gradCourse:['general'] },
  S79: { week:5, order:79, title:'Week 5 輸出', titleEn:'Week 5 Output', platform:'self', gradImportance:'support', tier:'tool', cognition:'synthesis', prereq:['S68'], assessWeight:'light', extension:'none', gradCourse:['general'] },
  S80: { week:5, order:80, title:'Week 5 檢討', titleEn:'Week 5 Review', platform:'self', gradImportance:'support', tier:'tool', cognition:'synthesis', prereq:['S78'], assessWeight:'light', extension:'none', gradCourse:['general'] },
};
